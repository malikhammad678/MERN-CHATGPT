  ...
  return (
    <div  className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'>
       ...
       {/* chat Messages */}
        ...
        {/* prompt input div */}
        <form onSubmit={onSubmitForm} className='bg-primary/20 dark:bg-[#583C79]/30 border border-primary dark:border-[#80609F]/30 rounded-full max-w-2xl w-full p-3 pl-4 mx-auto flex gap-4 items-center'>
